# Generated by Django 4.2.30 on 2026-08-07 00:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('frontend', '0005_learnerprofile_daily_goal_locked_at_quizattempt'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='frontend.chatthread')),
            ],
            options={
                'ordering': ['created_at'],
            },
